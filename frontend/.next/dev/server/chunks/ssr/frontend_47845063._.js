    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (uploadMode === 'file' && imageFile) {
                ...
                const { error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseClient"].storage.from('news-images').upload(filePath, imageFile);
                if (uploadError) throw uploadError;
                const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseClient"].storage.from('news-images').getPublicUrl(filePath);
