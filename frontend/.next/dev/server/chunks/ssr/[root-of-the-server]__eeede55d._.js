...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            // 1. Supabase Auth
            const { data: authData, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseClient"].auth.signInWithPassword({
                email,
                password,
                options: {
