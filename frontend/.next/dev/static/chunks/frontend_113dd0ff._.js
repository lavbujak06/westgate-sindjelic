...
"[project]/frontend/app/pages/women/seniors/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SeniorWomenPage() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SeniorWomenPage.useEffect": ()=>{
            fetch(`${("TURBOPACK compile-time value", "http://localhost:5001")}/api/league/configs`).then({
                "SeniorWomenPage.useEffect": (res)=>res.json()
            }["SeniorWomenPage.useEffect"]).then({
                "SeniorWomenPage.useEffect": (data)=>{
            ...
            fetch(`${("TURBOPACK compile-time value", "http://localhost:5001")}/api/media/senior-women`).then({
                "SeniorWomenPage.useEffect": (res)=>res.json()
            }["SeniorWomenPage.useEffect"]).then({
                "SeniorWomenPage.useEffect": (data)=>setGallery(Array.isArray(data) ? data : [])
            }["SeniorWomenPage.useEffect"]);
        }
    }["SeniorWomenPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(SeniorWomenPage, "0Jjj/8GvRG50g6XxUcmS1GKBc5A=");
_c = SeniorWomenPage;
var _c;
__turbopack_context__.k.register(_c, "SeniorWomenPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_113dd0ff._.js.map