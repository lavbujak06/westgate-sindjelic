...
"[project]/frontend/app/pages/women/reserves/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            fetch(`${("TURBOPACK compile-time value", "http://localhost:5001")}/api/league/configs`).then({
                ...
                "ReserveWomenPage.useEffect": (data)=>{
                    if (Array.isArray(data) && data.length > 0) {
                        ...
                        const reserveWomenOnly = data.filter({
                            "ReserveWomenPage.useEffect.reserveWomenOnly": (c)=>c.team_name === 'Reserve Women'
                        }["ReserveWomenPage.useEffect.reserveWomenOnly"]);
...
_s(ReserveWomenPage, "0Jjj/8GvRG50g6XxUcmS1GKBc5A=");
_c = ReserveWomenPage;
var _c;
__turbopack_context__.k.register(_c, "ReserveWomenPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_85f1c695._.js.map