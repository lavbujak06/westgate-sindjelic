...
"[project]/frontend/app/pages/news/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ArticlePage() {
    ...
    const [article, setArticle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "ArticlePage.useEffect": ()=>{
            const fetchArticle = {
                "ArticlePage.useEffect.fetchArticle": async ()=>{
                    if (!id) return;
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseClient"].from('news').select('*').eq('id', id).single();
    ...
    if (!article) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ArticlePage, "ANWBM0M/ftGgqJOVnLC/oYR/92I=", false, function() {
    return [
...
//# sourceMappingURL=frontend_52d3a3f3._.js.map