...
function MensPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MensPage.useEffect": ()=>{
            fetch('http://localhost:5001/api/mens/ladder').then({
                "MensPage.useEffect": (res)=>res.json()
            }["MensPage.useEffect"]).then({
                "MensPage.useEffect": (data)=>Array.isArray(data) && setLadder(data)
            }["MensPage.useEffect"]).catch({
                "MensPage.useEffect": (err)=>console.error('Error fetching ladder:', err)
            }["MensPage.useEffect"]);
            fetch('http://localhost:5001/api/mens/games').then({
                "MensPage.useEffect": (res)=>res.json()
            }["MensPage.useEffect"]).then({
                "MensPage.useEffect": (data)=>Array.isArray(data) && setGames(data)
            }["MensPage.useEffect"]).catch({
                "MensPage.useEffect": (err)=>console.error('Error fetching games:', err)
            }["MensPage.useEffect"]);
        }
    }["MensPage.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            className: "text-sm",
                                            children: games.map((g, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    className: "border-b hover:bg-gray-50 transition",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CoachStaff, {
                teamSlug: "senior-men"
            }, void 0, false, {
                fileName: "[project]/frontend/app/pages/men/seniors/page.tsx",
                lineNumber: 102,
...
_s(MensPage, "4s6RhMtvZmYS81xlT1DmXTldNYE=");
_c = MensPage;
var _c;
...
//# sourceMappingURL=frontend_6437acd5._.js.map