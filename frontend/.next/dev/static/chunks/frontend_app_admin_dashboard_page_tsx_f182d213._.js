        ...
        "AdminDashboard.useEffect": ()=>{
            const checkAdmin = {
                "AdminDashboard.useEffect.checkAdmin": async ()=>{
                    ...
                    const { data: adminData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseClient"].from('admins').select('*').eq('id', userId).single();
                    if (error || !adminData) {
                        router.push('/login');
                        return;
                    }
