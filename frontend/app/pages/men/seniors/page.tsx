...
export default function MensPage() {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:5001/api/media/senior-men')
      .then(res => res.json())
  ...
  return (
    <main className="bg-[#fcfcfc] min-h-screen pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 -mt-10 relative z-30">
        ...
        {/* 1. STATS & SELECTOR (Matches your preferred style) */}
        ...
        {/* 2. LADDER & GAMES (Kept exactly as requested) */}
        {loading ? (
          ...
          <>
            ...
            {/* 3. MATCH GALLERY (Located below tables, above coaches) */}
            {gallery.length > 0 && (
              <div className="mb-16">
