...
import { MediaItem, Match, Config, Ladder } from '@/app/types';

export default function ReserveMensPage() {
  ...
  return (
    <main className="bg-[#fcfcfc] min-h-screen pb-20">
      <Navbar />
      <Hero heading="Reserve Men" message="State League 1 North-West Reserves" showButton={false} />

      {/* TOP SECTION (Contained) */}
      ...
      {gallery.length > 0 && (
        <section className="w-full mb-16 overflow-hidden">
          ...
          {/* This container stretches to screen edges */}
