...
import { base64UrlToUint8Array, bytesToBase64URL } from '@supabase/auth-js/src/lib/base64url'
import { AuthError, AuthUnknownError, isAuthError } from '@supabase/auth-js/src/lib/errors'
import {
...
import { isBrowser } from '@supabase/auth-js/src/lib/helpers'
import type {
...
} from '@supabase/auth-js/src/lib/webauthn.errors'
