import GoTrueAdminApi from '@supabase/auth-js/src/GoTrueAdminApi'
import {
  ...
  JWKS_TTL,
  STORAGE_KEY,
} from '@supabase/auth-js/src/lib/constants'
import {
  AuthError,
...
} from '@supabase/auth-js/src/lib/errors'
import {
  Fetch,
  _request,
  _sessionResponse,
  ...
  _ssoResponse,
  _userResponse,
} from '@supabase/auth-js/src/lib/fetch'
import {
  decodeJWT,
  deepClone,
  Deferred,
...
import { LockAcquireTimeoutError, navigatorLock } from '@supabase/auth-js/src/lib/locks'
import { polyfillGlobalThis } from '@supabase/auth-js/src/lib/polyfills'
import { version } from '@supabase/auth-js/src/lib/version'

import { bytesToBase64URL, stringToUint8Array } from '@supabase/auth-js/src/lib/base64url'
import type {
  AuthChangeEvent,
...
import {
  ...
  SiweMessage,
  toHex,
} from '@supabase/auth-js/src/lib/web3/ethereum'
import {
